...
public:
    static GoldMine* create(const std::string& buildingFile, const std::string turfFile = "grass.png", float buildingScale = 0.8);
...
public:
    static ElixirCollector* create(const std::string& buildingFile, const std::string turfFile = "grass.png", float buildingScale = 0.8);
