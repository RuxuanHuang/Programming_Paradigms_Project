...
{
public:
    static GoldStorage* create(const std::string& buildingFile = "Gold_Storage1.png",
        const std::string turfFile = "grass.png",
...
{
public:
    static ElixirStorage* create(const std::string& buildingFile = "Elixir_Storage1.png",
        const std::string turfFile = "grass.png",
        float buildingScale = 0.7f);
